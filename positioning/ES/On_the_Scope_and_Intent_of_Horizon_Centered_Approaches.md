# Sobre el Alcance e Intención de los Enfoques Centrados en el Horizonte en Cosmología
...
- interpretación de las condiciones iniciales cosmológicas
- estatus de la inflación
- entropía y asimetría temporal
- significado de los horizontes causales
...
- accesibilidad causal
- dominios definidos por el horizonte
- entropía asociada al borde
- compatibilidad con la fenomenología establecida
...
## 3. Qué No Es el Programa

El programa no debe interpretarse como:

- un nuevo modelo cosmológico
- un reemplazo del ΛCDM
- una modificación de la Relatividad General
- una teoría de gravedad cuántica
- una ontología completa
- un marco predictivo
- una derivación de teorías existentes
...
## 4. Relación con Enfoques Existentes

El programa exhibe compatibilidad estructural con varias direcciones de investigación existentes, incluyendo:

- termodinámica de horizontes
- física cosmológica de horizontes
- perspectivas holográficas generales
- enfoques basados en estructura causal
...
## 5. Diferenciación de los Trabajos Previos Clave
...
## 6. Estatus de las Afirmaciones Interpretativas
...
Si los supuestos permanecen mutuamente consistentes.

### Claridad estructural
Si los conceptos y niveles de descripción permanecen claramente distinguidos.

### Compatibilidad con la fenomenología establecida
Si la reinterpretación preserva el éxito empírico. En la realización efectiva, esto se verifica mediante la recuperación de la dinámica de Friedmann a partir de la primera ley del horizonte, y la reproducción de un espectro de perturbaciones casi invariante de escala.

### Fertilidad interpretativa
Si el marco genera organización conceptual útil y motiva investigación adicional.
...
- origen microscópico de los grados de libertad del horizonte
- relaciones cuantitativas borde-a-bulk
- emergencia de geometría efectiva
- relación con la gravedad cuántica
- realizaciones dinámicas efectivas
