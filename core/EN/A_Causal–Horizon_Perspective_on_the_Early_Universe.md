# A Causal–Horizon Perspective on the Early Universe
...
## 0. Structural Position of the Framework

The present framework operates across three distinct but compatible levels:

**Ontological level:**
Physical domains are treated as causally self-consistent regions defined by causal accessibility and horizon structure.

**Interpretative level:**
Observed cosmological phenomena are reconsidered as manifestations of boundary conditions associated with causal horizons.

**Effective dynamical level:**
Standard cosmological evolution may admit reformulations in terms of horizon variables and thermodynamic relations, without modification of General Relativity.
...
Modern cosmology provides a quantitatively successful description of the observable universe within the ΛCDM framework. Combined with an early phase of accelerated expansion, the standard model successfully accounts for the cosmic microwave background (CMB), large-scale structure formation, and the observed expansion history.
...
## 2. Horizons as Fundamental Physical Structures
...
- horizons are associated with effective temperatures
- horizons carry entropy proportional to area
- physical descriptions depend on observer-dependent notions of accessibility
...
- no assumption is made regarding the microscopic origin of horizon entropy
- no specific model of primordial horizon dynamics is proposed
- inflationary phenomenology is not replaced
- standard recombination physics remains unchanged
...
## 4. The Cosmic Microwave Background as a Causal Boundary
...
- a radiation field associated with recombination
- an observational interface associated with a causal boundary
...
## 5. Inflation as an Emergent Horizon Phenomenon
...
## 6. Entropy, Information, and the Arrow of Time
...
## 7. Dimensionality and the Emergence of Space
...
## 8. Conceptual Implications and Consistency Expectations

The framework gives rise to several conceptual expectations:

- large-scale homogeneity may be viewed as compatible with shared boundary conditions
- inflationary behavior may admit horizon-centered interpretations
- entropy may be primarily associated with causal boundaries
- observable domains may be naturally characterized through causal accessibility
- temporal asymmetry may emerge locally rather than globally
- effective realizations of the framework yield a nearly scale-invariant perturbation spectrum ($n_s \approx 1$) under minimal statistical assumptions
